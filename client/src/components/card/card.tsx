...
const [isEditModalOpen, setIsEditModalOpen] = useState(false);
  ...
  const closeModal = () => {
    ...
    return (
        <div className='Card mx-5 my-5 min-w-[18vw] max-w-[18vw] min-h-[50vh] max-h-[50vh] truncate xl:max-2xl:min-h-[55vh]'>
                <div className="">
                ...
                <div className='text-l mx-8 h-[15vh] indent-5 break-words xl:max-2xl:text-[0.8em]'>
                {description}
                </div>
                <div className='flex h-5 justify-center my-2 items-center'>
                <p className="text-xl my-5 text-center font-bold xl:max-2xl:text-lg">PHP {price}</p></div>

                <div className="mx-10 flex space-x-5 items-center">
                <button className='CardButton flex DetailsButton text-[1.1rem] w-1/2 items-center justify-center xl:max-2xl:text-[0.7em]' 
                ...
                {oneButton === false &&
                  <button className='CardButton flex EditButton text-[1.1rem] w-1/2 items-center justify-center xl:max-2xl:text-[0.7em]' 
