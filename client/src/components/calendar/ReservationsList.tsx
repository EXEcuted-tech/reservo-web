...
useEffect(() => {
  ...
  return (
    <>
    <div className='bg-[rgba(0,0,0,0.6)] w-[100vw] h-[100vh] z-20 absolute top-0 left-0 duration-100 animate-fade-in'>
      ...
      :
        ...
        <div className='flex mx-[2%] py-[2%] text-[1.2em] xl:max-2xl:text-[0.8em]'>
            <table className="w-[100%] table-fixed">
                ...
                <th className='font-bold uppercase text-[1.0em] ml-[4%] px-[1%] mt-[2%]  rounded-lg mb-[0.5%] xl:max-2xl:text-[1.3em]'>Client Name</th>
