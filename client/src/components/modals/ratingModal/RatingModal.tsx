       ...
       <form className='animate-fade-in font-poppins fixed left-[35%] top-[35%] w-[100%] h-[100%] z-[100] overflow-auto drop-shadow bg-[rgba(0, 0, 0, 0.5)] xl:max-2xl:top-[30%]'>
        <div className="bg-white w-[30%] p-4 text-center border border-black rounded-2xl xl:max-2xl:w-[35%]">
          ...
          <div className="mb-[2%] xl:max-2xl:mb-[1%]">
            <Rating className='simple-controlled xl:max-2xl:scale-[0.75]' size="large" value={null}/>
          </div>
          <div>
            <textarea className='w-[90%] border mb-[3%] xl:max-2xl:text-[0.8em]' rows ={5} cols ={50} name = "feedback" placeholder="Enter feedback here..."> </textarea>
          </div>
          <button className='bg-green-600 text-white rounded-lg h-[2.5rem] w-[25%] p-[1%] mb-[2%] cursor-pointer 
            hover:bg-green-700 transition-colors delay-450 duration-[3000] ease-in-out transform scale-100 xl:max-2xl:text-[0.8em] xl:max-2xl:w-[30%] xl:max-2xl:h-[2rem]'>Submit Review</button>
        </div>
        </form>
    </div>
  )
