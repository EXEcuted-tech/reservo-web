...
const ImageEditModal: React.FC<ImageEditModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  return (
    <div className={`modal ${isOpen ? 'block animate-fade-in h-[9rem]' : 'hidden'}`}>
      ...
      <div className="modal-container">
        ...
        <div className="modal-footer p-3 ml-1 ">
          <button 
                type="submit"
          ...
          <button 
                className="btn btn-secondary w-[6rem] ml-6 text-white bg-[#840705] p-[0.30rem] text-[1.1rem] items-center rounded-lg hover:bg-[#5a1513] transition-colors delay-250 duration-[3000] ease-in" 
                onClick={onClose}>
            Cancel
          </button>
        </div>
