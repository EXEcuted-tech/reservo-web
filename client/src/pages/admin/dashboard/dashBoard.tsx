...
const AdminDashboard = () => {
	...
	// const formattedAccountsData = adgraphList.map((item) => [
	// 	new Date(item.signup_year, item.signup_month),
	// 	item.count_merchant,
	// 	item.count_user,
	// ]);

	const LineData = [["x", "Merchants", "Users"], ...formattedAccountsData];
			...
			<div className="bg-[#F3F3F3] h-[30vh] flex">
				<div className="w-[35%] p-[1%] items-center">
					<div className="align-center text-left p-[3%] h-[100%] rounded-3xl bg-gradient-to-b from-[#EC0000] to-black pl-10 pt-7">
						<h1 className="text-[1.8em] text-white">Welcome, Kathea Marie!</h1>
				...
				<div className="w-[65%] p-[1%] text-center">
					<div className="p-[3%] h-[100%] rounded-3xl bg-gradient-to-t from-[#660605] to-[#7e0806] grid-cols-2 grid-rows-2 gap-1 flex">
						<div className="w-[33%]">
							<p className="text-white mt-[-5%] text-[8em] font-bold flex-col">
								35
							</p>
							<p className="text-white text-[2em] flex-col mt-[-10%]">
								Merchants
							</p>
						</div>
						<div className="w-[33%]">
