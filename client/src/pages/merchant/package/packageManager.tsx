...
<div className={`bg-[#FFFFFF] h-[100vh] font-poppins overflow-y-auto overflow-x-hidden animate-fade-in`}>
    ...
    <div className="SortFilterSubheader flex mb-4 text-lg bg-[#f0e5d8] w-[85vw] xs:max-sm:w-full">
        <div className="flex align-middle w-3/6 items-center mx-32 ps-8 h-20 xs:max-sm:ps-2 xs:max-sm:mx-2 xs:max-sm:h-16 xl:max-2xl:ps-2">
        <label htmlFor="filterDropdown" className={`font-bold mx-2 w-[4vw] xs:max-sm:text-[0.8em] xs:max-sm:w-[40%] xl:max-2xl:text-[0.8em] xl:max-2xl:w-[5vw]`}>
          Sort By: </label>
                    <select 
                        id="sortDropdown" 
                        name="sortDropdown" 
                        className={`bg-transparent rounded-md h-10 w-[20vw] xs:max-sm:text-[0.8em] xs:max-sm:w-[60%] xl:max-2xl:text-[0.8em]  
    ...
    <div className='PublishedPackages ps-20 xs:max-sm:ps-0'>
      <div className='grid grid-flow-col'>
        ...
        <div className='flex justify-end items-center mx-10' ><button
