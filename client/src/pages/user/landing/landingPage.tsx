...
const LandingPage = () => {
  return (
    ...
    <div className = "bg-[#F9F2EA] font-poppins animate-fade-in">
      ...
      {/*SECTION*/}
        <div className = "block align-middle h-full px-60 py-32 xl:max-2xl:py-20">

          <div className="pb-20 flex flex-col items-center justify-center">
            <img src={img1} alt="Landing Page Image 1" className="h-auto max-w-full mb-20 transform scale-100 xl:max-2xl:scale-75 xl:max-2xl:mb-12 xl:max-2xl:ml-[5rem]"></img>
        ...
        {/* CARDS */}
        <div className="flex mb-20 ml-[3%] mt-10 drop-shadow-lg xl:max-2xl:ml-[2%] xl:max-2xl:mt-6 xl:max-2xl:mb-12">
          <div className ="group h-80 w-1/4 ml-16 mb-20 text-center bg-white hover:bg-[#ffd381] transition-colors duration-[3000] ease-in drop-shadow-lg xl:max-2xl:w-[130vh] xl:max-2xl:h-[48vh] xl:max-2xl:p-2 xl:max-2xl:ml-[1%]">
            ...
            <div className ="group h-80 w-1/4 ml-28 mb-20 text-center  bg-white hover:bg-[#ffd381] transition-colors duration-[3000] ease-in drop-shadow-lg xl:max-2xl:w-[130vh] xl:max-2xl:h-[48vh] xl:max-2xl:p-2 xl:max-2xl:ml-[4rem]">
        ...
        <div className= "bg-white p-3 drop-shadow-lg">
          <div className="flex justify-center">
            <img src={starleft} alt="star-1" className="h-12 w-15 mt-[1.2%] xl:max-2xl:h-10 xl:max-2xl:w-10 xl:max-2xl:mt-[3%]"></img>
            <h1 className = "text-5xl text-center font-bold p-5 xl:max-2xl:text-4xl">ALL TIME FAVORITES</h1>
            <img src={starright} alt="star-2" className="h-12 w-15 mt-[1.2%] xl:max-2xl:h-10 xl:max-2xl:w-10 xl:max-2xl:mt-[3%]"></img>
          </div>
          

        {/* RESTOS */}
        <div className= "flex justify-center pt-12 mb-20 xl:max-2xl:pt-10 xl:max-2xl:mb-10">
          <div className ="group h-full w-96 xl:max-2xl:w-[33rem] xl:max-2xl:ml-[1%]">
              <img src={food1} className="rounded-full h-60 w-60 mb-8 ring-8 ml-16 ring-[#DD2803] ring-offset-8 group-hover:ring-4 group-hover:scale-95 transition-transform duration-[1000] ease-in-out xl:max-2xl:w-[9rem] xl:max-2xl:h-[9rem] xl:max-2xl:ring-4 xl:max-2xl:ring-offset-4"></img>
            ...
            <div className ="group h-full w-96 ml-[6%] xl:max-2xl:w-[33rem] xl:max-2xl:ml-[1%]">
              <img src={food3} className="rounded-full h-60 w-60 mb-8 ring-8 ml-16 ring-[#DD2803] ring-offset-8 group-hover:ring-4 group-hover:scale-95 transition-transform duration-[1000] ease-in-out xl:max-2xl:w-[9rem] xl:max-2xl:h-[9rem] xl:max-2xl:ring-4 xl:max-2xl:ring-offset-4"></img>
            ...
            <div className ="group h-full w-96 ml-[6%] xl:max-2xl:w-[33rem] xl:max-2xl:ml-[1%]">
              <img src={food2} className="rounded-full h-60 w-60 mb-8 ring-8 ml-16 ring-[#DD2803] ring-offset-8 group-hover:ring-4 group-hover:scale-95 transition-transform duration-[1000] ease-in-out xl:max-2xl:w-[9rem] xl:max-2xl:h-[9rem] xl:max-2xl:ring-4 xl:max-2xl:ring-offset-4"></img>
        ...
        <div className="flex items-center justify-center">
          ...
          <button className= " text-2xl p-5 mb-10 rounded-2xl text-white bg-[#DD2803] hover:bg-[#A01B00] transition-colors delay-250 duration-[3000] ease-in xl:max-2xl:text-[0.8em] xl:max-2xl:h-[3rem] xl:max-2xl:p-2">View Eatery Choices</button>
          </Link>
        </div>
        </div>
        </div>
