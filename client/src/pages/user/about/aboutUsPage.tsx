...
const AboutUsPage = () => {
  return (
    <div className='h-[80vh] bg-[#F9F2EA] animate-fade-in xs:max-sm:h-[100vh] xl:max-2xl:h-[76vh]'>
      <div className='font-poppins relative flex flex-row justify-between bg-black bg-opacity-40 z-10 h-[100%] w-[100%]'>
        ...
        <div className='w-4/5 px-32 py-24 z-0 xs:max-sm:px-10 xs:max-sm:py-10 xs:max-sm:inline-block xs:max-sm:h-1/5 xs:max-sm:w-[100%] xl:max-2xl:px-60 xl:max-2xl:py-8'>
          <div className='border-b-4 pb-6 xl:max-2xl:border-b-2 xs:max-sm:text-center'>
            <h1 className='font-extrabold text-white text-8xl pb-3 xs:max-sm:text-3xl xl:max-2xl:text-6xl'>Choose.</h1>
            <h1 className='font-extrabold text-white text-8xl pb-3 xs:max-sm:text-3xl xl:max-2xl:text-6xl'>Connect.</h1>
            <h1 className='font-extrabold text-white text-8xl pb-3 xs:max-sm:text-3xl xl:max-2xl:text-6xl'>Celebrate.</h1>
          ...
          <div className='pt-8 xl:max-2xl:pt-4'>
            <p className='text-white font-light text-justify text-2xl xs:max-sm:text-[0.9em] xl:max-2xl:text-[0.9em]'>
Reservo, developed by the Cebu-based team EXEcuted, consists of talented BSIT students determined to further their expertise in the IT field through their collaborative efforts. In line with that, the team decided to make a centralized reservation management system for the benefit of both the customers and food businesses.</p>
        ...
        <div className='bg-black bg-opacity-70 rounded-l-3xl py-[15%] px-[5vh] z-0 h-[60%] flex items-center self-center xs:max-sm:inline-block xs:max-sm:h-[500px] xs:max-sm:px-3 xs:max-sm:py-[7%]'>
          <table>
            <tbody>
              <tr>
