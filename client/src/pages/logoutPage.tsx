      ...
      <div className='flex flex-row justify-even place-items-center bg-logout'>
        <div className='flex flex-col xs:max-sm:w-full xs:max-sm:text-center mr-[7%]'>
          ...
          <div className='flex'>
            ...
            hover:bg-[#A01B00] transition-colors delay-250 duration-[3000] ease-in xs:max-sm:text-sm xs:max-sm:ml-[30%] xs:max-sm:py-1 xl:max-2xl:text-xl'>
              Return to Login Page</Link>
          </div>
        </div>

        <div className="xs:max-sm:fixed xs:max-sm:top-[20%] xs:max-sm:left-[13%]">
          <img src={PeopleWaving} alt="people-waving" className='w-[900px] mr-[500px] xs:max-sm:w-[300px] xs:max-sm:mr-[150px] 
          xl:max-2xl:w-[600px] xl:max-2xl:mr-[300px]'/>
        </div>
      </div>
    </div>
  )
